...
gf <- list(
  gene_flow(from = nea, to = nonafr, migration_rate = 0.02, start = 55000, end = 50000),
  gene_flow(from = den, to = pap, migration_rate = 0.05, start = 35000, end = 30000)
)
...
```{r}
gf <- list(
  gene_flow(from = ana, to = yam, migration_rate = 0.5, start = 6500, end = 6400, overlap = FALSE),
  gene_flow(from = ana, to = eur, migration_rate = 0.5, start = 8000, end = 6000),
  gene_flow(from = yam, to = eur, migration_rate = 0.75, start = 4000, end = 3000)
)
```
