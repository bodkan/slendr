...
xrange <- c(-15, 60)
yrange <- c(20, 65)
land1 <- region(polygon = list(c(-10, 30), c(50, 30), c(40, 50), c(0, 40)))
land2 <- region(polygon = list(c(-10, 30) + 10, c(50, 30) + 10, c(40, 50) + 10, c(0, 40) + 10))
land <- combine(land1, land2)
map <- world(xrange = xrange, yrange = yrange, landscape = land)
...
ehg <- population(
  ...
  polygon = list(c(26, 55), c(38, 40), c(48, 53), c(60, 53),
...
ana <- population(
  ...
  center = c(34, 38), radius = 10, polygon = anatolia
) %>% expand(
