...
#' @param output A shared prefix path of output files that will be generated by
...
msprime <- function(model, sequence_length, recombination_rate,
                    ...
                    samples = NULL, verbose = FALSE, random_seed = NULL,
