...
#'
#' @param maps Population map objects of the 'spammr_pop' class
...
#'
#' @export
compile <- function(maps, output_dir, admixtures = NULL, overwrite = FALSE) {
  pops <- maps
...
#'
#' @export
admixture <- function(from, to, rate, start, end) {
