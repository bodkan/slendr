...
#'
#' @param populations Population map objects of the \code{spannr_pop} class (a
...
#' Read a previously serialized spannr model
#'
...
#'
#' @param pops Spatial population objects of the 'spannr_pop' class
#'
#' @import ggplot2
...
#'
#' @param x Object of the 'spannr_pop' class
#' @param resolution How many kilometers per pixel?
