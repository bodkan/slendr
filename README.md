...
## Spatio-Temporally-Aware Models of Populations in R and SLiM <a href='https://bodkan.net/stamp'><img src='man/figures/logo.png' align="right" height="139" /></a>
...
[tutorial](https://bodkan.net/stamp/articles/tutorial.html). Note
...
website](https://www.github.com/bodkan/stamp).
...
section [of the
tutorial](https://bodkan.net/stamp/articles/tutorial.html#installation-and-setup-1). Note
...
Here is a small demonstration of what *stamp* is designed to do. Note that this model is not supposed to recapitulate the history of any known species and serves just for demonstration purposes.

For a more complete example that is less abstract and demonstrates the usage of the package on a model of West Eurasian history, please see the [tutorial](https://bodkan.net/stamp/articles/tutorial.html).
