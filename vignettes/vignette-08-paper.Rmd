...
```{r, eval = !file.exists("~/Documents/postdoc/slendr/slendr_models/ex1/output_msprime.trees")}
...
```{r, eval = !file.exists("~/Documents/postdoc/slendr/slendr_models/ex1/output_slim.trees")}
...
```{r, include = FALSE, eval = file.exists("~/Documents/postdoc/slendr/slendr_models/ex1/output_msprime.trees") && file.exists("~/Documents/postdoc/slendr/slendr_models/ex1/output_slim.trees")}
...
```{r, eval = !file.exists("~/Documents/postdoc/slendr/slendr_models/ex2/output_slim.trees")}
...
```{r, include = FALSE, eval = file.exists("~/Documents/postdoc/slendr/slendr_models/ex2/output_slim.trees")}
...
```{r, eval = !file.exists("~/Documents/postdoc/slendr/slendr_models/ex3/output_slim.trees")}
map <- world(xrange = c(-15, 60), yrange = c(20, 65), crs = 3035)
...
model <- compile_model(
  path = "~/Documents/postdoc/slendr/slendr_models/ex3", overwrite = TRUE, force = TRUE,
...
```{r, include = FALSE, eval = file.exists("~/Documents/postdoc/slendr/slendr_models/ex3/output_slim.trees")}
...
```{r, figure_ex3, fig.height=5, fig.width=7, eval = file.exists("~/Documents/postdoc/slendr/slendr_models/ex3/output_slim.trees"), class.source = "fold-hide"}
...
```{r, figure_ex4, eval = file.exists("~/Documents/postdoc/slendr/slendr_models/ex3/output_slim.trees") && requireNamespace("ggtree"), fig.height=9, fig.width=7, class.source = "fold-hide"}
