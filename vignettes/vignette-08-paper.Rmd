...
knitr::opts_chunk$set(
  ...
  comment = "#>",
  dpi = 80,
  eval = TRUE # Sys.which("slim") != "" && env_present
)
```
...
```{r, include = FALSE, eval = !file.exists("~/Desktop/slendr/ex1/output_slim.trees"), class.source = "fold-hide"}
...
```{r, include = FALSE, eval = file.exists("~/Desktop/slendr/ex1/output_msprime.trees") && file.exists("~/Desktop/slendr/ex1/output_slim.trees"), class.source = "fold-hide"}
...
```{r, figure_ex3, fig.height=5, fig.width=7, eval = file.exists("~/Desktop/slendr/ex3/output_slim.trees"), class.source = "fold-hide"}
...
```{r, figure_ex4, eval = file.exists("~/Desktop/slendr/ex3/output_slim.trees") && requireNamespace("ggtree"), fig.height=9, fig.width=7, class.source = "fold-hide"}
