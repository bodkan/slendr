...
ggsave("/Users/mp/Documents/postdoc/slendr-paper/ex1.pdf", p_ex1, width = 9, height = 6, units = "in")
```
...
```{r, include = FALSE, eval = eval_chunk && save_pdf}
ggsave("/Users/mp/Documents/postdoc/slendr-paper/ex2.pdf", p_ex2, width = 6, height = 9, units = "in")
```
...
```{r, include = FALSE, eval = eval_chunk && save_pdf}
ggsave("/Users/mp/Documents/postdoc/slendr-paper/ex3.pdf", p_ex3, width = 9, height = 6, units = "in")
```
...
<!-- pdf("/Users/mp/Documents/postdoc/slendr-paper/anc.pdf") -->
<!-- for (e in eurs) { -->
...
p_map <- ggplot() +
  ...
  geom_sf_label(data = nodes[nodes$sampled & nodes$name != "EUR_581", ],
                aes(label = label, fill = pop), size = 3, color = "white") +
  geom_sf_label(data = nodes[nodes$sampled & nodes$name == "EUR_581", ],
...
```{r, include = FALSE, eval = eval_chunk && save_pdf}
ggsave("/Users/mp/Documents/postdoc/slendr-paper/ex4.pdf", p_ex4, width = 7, height = 9, units = "in")
```
