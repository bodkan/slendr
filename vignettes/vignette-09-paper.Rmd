...
system(sprintf("cp -r %s %s", model$path, "/Users/mp/Documents/KU/archive/slendr-paper/preprint_models_v0.5/ex1"))
ts_write(ts, "/Users/mp/Documents/KU/archive/slendr-paper/preprint_models_v0.5/ex1.trees")
```
...
ggsave("/Users/mp/Documents/KU/archive/slendr-paper/preprint_models_v0.5/ex1.pdf", p_ex1, width = 9, height = 6, units = "in")
```
...
```{r, echo = FALSE, eval = env_present && record_snapshot}
system(sprintf("cp -r %s %s", model$path, "/Users/mp/Documents/KU/archive/slendr-paper/preprint_models_v0.5/ex2"))
ts_write(ts, "/Users/mp/Documents/KU/archive/slendr-paper/preprint_models_v0.5/ex2.trees")
```
...
```{r, include = FALSE, eval = env_present && record_snapshot}
ggsave("/Users/mp/Documents/KU/archive/slendr-paper/preprint_models_v0.5/ex2.pdf", p_ex2, width = 6, height = 9, units = "in")
```
...
gf <- list(
  gene_flow(ana, to = yam, proportion = 0.5, start = 6500, end = 5000),
  gene_flow(ana, to = eur, proportion = 0.6, start = 8000, end = 6000),
  gene_flow(yam, to = eur, proportion = 0.7, start = 3500, end = 3000)
)
...
ts <- slim(
  model, burnin = 200000, schedule = samples, random_seed = SEED,
  sequence_length = 200000, recombination_rate = 1e-8
)
```

```{r, echo = FALSE, eval = env_present && record_snapshot}
system(sprintf("cp -r %s %s", model$path, "/Users/mp/Documents/KU/archive/slendr-paper/preprint_models_v0.5/ex3"))
ts_write(ts, "/Users/mp/Documents/KU/archive/slendr-paper/preprint_models_v0.5/ex3.trees")
```
...
devtools::load_all()
init_env()
model <- read_model("/Users/mp/Documents/KU/archive/slendr-paper/preprint_models_v0.5/ex3")
ts <- ts_read("/Users/mp/Documents/KU/archive/slendr-paper/preprint_models_v0.5/ex3.trees", model = model)
...
```{r, include = FALSE, eval = env_present && record_snapshot}
ggsave("/Users/mp/Documents/KU/archive/slendr-paper/preprint_models_v0.5/ex3.pdf", p_ex3, width = 9, height = 6, units = "in")
```
...
```{r, echo = FALSE, eval = env_present && record_snapshot}
ts_write(ts, "/Users/mp/Documents/KU/archive/slendr-paper/preprint_models_v0.5/ex3_small.trees")
```
...
```{r, include = FALSE, eval = env_present && record_snapshot}
ggsave("/Users/mp/Documents/KU/archive/slendr-paper/preprint_models_v0.5/ex4.pdf", p_ex4, width = 8.5, height = 9, units = "in")
```
