...
To demonstrate this feature, let's look at a simple example.  Let's make a rectangular world first:
...
Once the simulation has finished running, we can recapitulate the spatial population dynamics simulated by the SLiM back end script as an animated GIF:
