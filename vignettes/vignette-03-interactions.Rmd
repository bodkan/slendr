...
We have constructed seven populations, each occupying a discrete circular range on a blank landscape `r dimensions(map)[1]` distances units wide and `r dimensions(map)[2]` distance units tall. All are programmed to appear in the simulation in generation one and have the same number of individuals.
...
slim(model, sequence_length = 1, recombination_rate = 0, save_locations = TRUE,
     burnin = 100, method = "batch", verbose = TRUE, random_seed = 314159)
```
