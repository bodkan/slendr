...
```{r}
p1 <- set_dispersal(p1, time = 100, competition_dist = 80)
p2 <- set_dispersal(p2, time = 200, competition_dist = 130)
p3 <- set_dispersal(p3, time = 300, competition_dist = 170)
p4 <- set_dispersal(p4, time = 400, competition_dist = 220)
p5 <- set_dispersal(p5, time = 500, competition_dist = 300)
p6 <- set_dispersal(p6, time = 600, competition_dist = 380)
```
...
animate_model(model, steps = 80, width = 500, height = 200)
```
