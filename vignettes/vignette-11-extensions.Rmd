...
Let's say that we defined the following model of modern human demographic history in slendr. This is exactly the same example as the one we show in [vignette #4](https://www.slendr.net/articles/vignette-04-nonspatial-models.html):
