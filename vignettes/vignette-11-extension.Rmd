...
model_for_plotting <- compile_model(
  populations = list(nea, eur), gene_flow = gf,
  generation_time = 30,
  extension = extension
)

plot_model(model_for_plotting, proportions = TRUE, order = c("NEA", "EUR"))
```
...
This functionality clearly makes most difference for complex models -- either complex from a demographic perspective (lots of lineages, gene flow, etc) or from the perspective of a genomic architecture (polygenic selection, complex traits).
