...
Below we will describe the following slendr / SLiM "API" functions and constants you can use to customize the default, purely neutral, SLiM back-end script built-in to _slendr_:
...
slim(model_eur, sequence_length = 1e6, recombination_rate = 1e-8, output_dir = "~/Desktop/trajectories")
```
...
plot_model(model, proportions = TRUE, order = c("NEA", "EUR"))
```
