...
```{r}
chimp <- population("chimp", time = 1.1e6, N = 5000)#, remove = 599e3)

# two populations of anatomically modern humans: Africans and Europeans
afr <- population("AFR", parent = chimp, time = 1e6, N = 10000)
...
plot_model(model, proportions = TRUE, order = c("chimp", "NEA", "EUR", "AFR"))
