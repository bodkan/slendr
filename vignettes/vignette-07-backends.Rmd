...
samples <- schedule_sampling(model_nogf, times = 4500,
...
model_gf <- compile_model(populations = list(a, b, x1, x2, c, o), geneflow = gf, generation_time = 1, sim_length = 4500) 

samples <- schedule_sampling(model_gf, times = 4500,
                    list(a, 1), list(b, 1), list(x1, 50), list(x2, 50), list(c, 1), list(o, 1))
```
