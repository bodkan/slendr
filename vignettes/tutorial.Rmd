...
First, let's install the latest version of the package and load it. The package carries some SLiM dependencies which makes the installation procedure a little cumbersome. This will be fixed soon, but for now you have to first:
