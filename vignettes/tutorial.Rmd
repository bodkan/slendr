...
In case you'd want to separate model specification and running into different scripts, _spammr_ includes a function `read()` just for this purpose:
...
Similarly, we can recapitulate the spatial dynamics with the _spammr_
