...
What we ultimately want to be able to do is to simulate this kind of population history (splits and admixture events)

[admixture graph](admixture_graph.png)
