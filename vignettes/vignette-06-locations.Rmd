...
We begin by specifying our spatial model. We will use the same demographic model of modern human history in West Eurasia, which we extensively discussed in the [introductory tutorial](vignette-01-tutorial.html) and on the main [landing page](https://bodkan.net/slendr/). Here is a complete model definition script, without further comments:
...
# geneflow events
gf <- list(
  gene_flow(from = ana, to = yam, proportion = 0.5, start = 6000, end = 5000, overlap = FALSE),
...
ts <- slim(
  ...
  schedule = samples, method = "batch", random_seed = 314159, max_attempts = 1
) %>%
