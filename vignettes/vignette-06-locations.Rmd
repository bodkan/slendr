...
```{r}
slim(
  model, seq_length = 100e3, recombination_rate = 1e-8, burnin = 200e3,
  sampling = samples, method = "batch", seed = 314159, max_attempts = 1
)
```
...
```{r}
ts <- ts_load(model, recapitate = TRUE, simplify = TRUE, recombination_rate = 1e-8, Ne = 10000)
```
...
ts_small <- ts_simplify(ts, c("AFR_1", "EUR_1", "YAM_1", "EHG_1", "OOA_1", "ANA_1"))
