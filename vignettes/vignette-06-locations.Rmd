...
We begin by specifying our spatial model. We will use the same demographic model of modern human history in West Eurasia, which we extensively discussed in the [introductory tutorial](vignette-01-tutorial.html) and on the main [landing page](https://bodkan.github.io/slendr/). Here is a complete model definition script, without further comments:
