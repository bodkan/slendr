...
nea <- population("NEA", parent = anc, time = 600e3, N = 1000, remove = 35e3)
...
model <- compile(
  populations = list(anc, chimp, nea, afr, eur, asn), geneflow = gf,
  generation_time = 30,
...
present_samples <- sampling(model, times = 0, list(chimp, 1), list(afr, 1),
