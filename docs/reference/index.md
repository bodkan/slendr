...
- [`slim()`](https://bodkan.net/slendr/reference/slim.md) : Run a slendr
  model in SLiM
- [`msprime()`](https://bodkan.net/slendr/reference/msprime.md) : Run a
  slendr model in msprime
- [`compile_model()`](https://bodkan.net/slendr/reference/compile_model.md)
  : Compile a slendr demographic model
- [`read_model()`](https://bodkan.net/slendr/reference/read_model.md) :
...
- [`init_env()`](https://bodkan.net/slendr/reference/init_env.md) :
  Activate slendr's own dedicated Python environment
- [`check_env()`](https://bodkan.net/slendr/reference/check_env.md) :
  Check that the active Python environment is setup for slendr
- [`clear_env()`](https://bodkan.net/slendr/reference/clear_env.md) :
...
- [`population()`](https://bodkan.net/slendr/reference/population.md) :
  Define a population
- [`world()`](https://bodkan.net/slendr/reference/world.md) : Define a
  world map for all spatial operations

## Spatial population dynamics

- [`move()`](https://bodkan.net/slendr/reference/move.md) : Move the
  population to a new location in a given amount of time
...
- [`resize()`](https://bodkan.net/slendr/reference/resize.md) : Change
  the population size
...
- [`reproject()`](https://bodkan.net/slendr/reference/reproject.md) :
  Reproject coordinates between coordinate systems

- [`distance()`](https://bodkan.net/slendr/reference/distance.md) :
  Calculate the distance between a pair of spatial boundaries

- [`area()`](https://bodkan.net/slendr/reference/area.md) : Calculate
  the area covered by the given slendr object
...
- [`ts_read()`](https://bodkan.net/slendr/reference/ts_read.md) : Read a
  tree sequence from a file
- [`ts_write()`](https://bodkan.net/slendr/reference/ts_write.md) : Save
  a tree sequence to a file
...
- [`ts_mutate()`](https://bodkan.net/slendr/reference/ts_mutate.md) :
...
- [`ts_samples()`](https://bodkan.net/slendr/reference/ts_samples.md) :
  ...
  simplified to)
- [`ts_names()`](https://bodkan.net/slendr/reference/ts_names.md) :
...
- [`ts_save()`](https://bodkan.net/slendr/reference/ts_save.md) : Write
  a tree sequence to a file
- [`ts_load()`](https://bodkan.net/slendr/reference/ts_load.md) : Read a
  tree sequence from a file
...
- [`ts_vcf()`](https://bodkan.net/slendr/reference/ts_vcf.md) : Save
  genotypes from the tree sequence as a VCF file
...
- [`ts_edges()`](https://bodkan.net/slendr/reference/ts_edges.md) :
  Extract spatio-temporal edge annotation table from a given tree or
  tree sequence

- [`ts_table()`](https://bodkan.net/slendr/reference/ts_table.md) : Get
  the table of individuals/nodes/edges/mutations/sites from the tree
  sequence
...
- [`ts_tree()`](https://bodkan.net/slendr/reference/ts_tree.md) : Get a
  tree from a given tree sequence
...
- [`ts_afs()`](https://bodkan.net/slendr/reference/ts_afs.md) : Compute
...
- [`ts_tajima()`](https://bodkan.net/slendr/reference/ts_tajima.md) :
