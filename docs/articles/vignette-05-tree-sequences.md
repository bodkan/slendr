...
[`setup_env()`](https://slendr.net/reference/setup_env.md) will not
...
[`check_env()`](https://slendr.net/reference/check_env.md) to make sure
...
[`slim()`](https://slendr.net/reference/slim.md) function shown in
...
vignette](https://slendr.net/articles/vignette-07-backends.html).

The simulation back end utilized by the
[`msprime()`](https://slendr.net/reference/msprime.md) function (as well
as the [`slim()`](https://slendr.net/reference/slim.md) function)
...
[here](https://slendr.net/articles/vignette-04-nonspatial-models.html)
and [here](https://slendr.net/reference/schedule_sampling.html) for a
...
By default, any [`msprime()`](https://slendr.net/reference/msprime.md)
or [`slim()`](https://slendr.net/reference/slim.md) run will produce a
...
[`ts_read()`](https://slendr.net/reference/ts_read.md). If we’re dealing
...
generated by
[`compile_model()`](https://slendr.net/reference/compile_model.md) above
...
[`msprime()`](https://slendr.net/reference/msprime.md) function. This
shows that under normal circumstances, loading the output manually via
[`ts_read()`](https://slendr.net/reference/ts_read.md) is not needed.
...
[`ts_simplify()`](https://slendr.net/reference/ts_simplify.md) which we
...
[`ts_recapitate()`](https://slendr.net/reference/ts_recapitate.md) which
performs
...
[`ts_coalesced()`](https://slendr.net/reference/ts_coalesced.md). This
is useful when dealing with
[`slim()`](https://slendr.net/reference/slim.md)-produced tree
sequences:
...
[`ts_phylo()`](https://slendr.net/reference/ts_phylo.md) which can be
...
functions](https://slendr.net/reference/index.md) with the prefix
...
[`ts_coalesced()`](https://slendr.net/reference/ts_coalesced.md) on the
...
[`ts_f4()`](https://slendr.net/reference/ts_f4ratio.md) and
[`ts_f4ratio()`](https://slendr.net/reference/ts_f4ratio.md) which
...
function [`ts_samples()`](https://slendr.net/reference/ts_samples.md):
...
in the [`ts_f4ratio()`](https://slendr.net/reference/ts_f4ratio.md)
...
[`ts_vcf()`](https://slendr.net/reference/ts_vcf.md) to save the
...
[`ts_fst()`](https://slendr.net/reference/ts_fst.md).

If a single genome-wide $`F_{st}`$ is to be calculated (i.e. not a
window-based calculation), the
[`ts_fst()`](https://slendr.net/reference/ts_fst.md) returns a simple
...
[`ts_fst()`](https://slendr.net/reference/ts_fst.md) accepts a `windows`
...
The function [`ts_tajima()`](https://slendr.net/reference/ts_tajima.md)
has nearly the same interface as
[`ts_fst()`](https://slendr.net/reference/ts_fst.md) shown above.
...
function
[`ts_diversity()`](https://slendr.net/reference/ts_diversity.md). For
...
[`ts_diversity()`](https://slendr.net/reference/ts_diversity.md) expects
as an input):
...
manual](https://slendr.net/reference/index.html#section-tree-sequence-statistics)
...
ends](https://slendr.net/articles/vignette-07-backends.html) of the
*slendr* package.
