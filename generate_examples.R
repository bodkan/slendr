...
gf <- gene_flow(from = nea, to = eur, proportion = 0.03, start = 55000, end = 45000)
...
ts_slim %>%
  ...
  ts_write("inst/extdata/models/introgression_slim.trees")
...
ts_msprime %>% ts_write("inst/extdata/models/introgression_msprime.trees")
